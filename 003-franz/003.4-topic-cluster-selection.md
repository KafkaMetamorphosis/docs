...
`POST` `/api/v0/topic-definitions-expansion`
```json
// Request Body
{
...
[
    {
        ...
        "labels": {
            ...
            "franz.taint": "team-x:no-schedule",
...
|my-fleet/tier=high-volume,<br>my-fleet/env=prod,<br>my-fleet/geo=br,<br>franz.taint/toleration=team-x:no-schedule|br_prod_high_volume_0001,<br>br_prod_high_volume_0003,<br>br_prod_high_volume_0004|br_prod_high_volume_0003 | (since it has the biggest weight)|
|my-fleet/tier=high-volume,<br>my-fleet/env=prod,<br>my-fleet/geo=br,<br>franz.taint/toleration=team-x:no-schedule,<br>my-fleet/my-label=team-x| br_prod_high_volume_0001| br_prod_high_volume_0001 | (unique that matches and it also tolerates)|
