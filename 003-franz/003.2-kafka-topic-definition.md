...
|---|---|---|
| `GET` | `/api/v0/topic_configuration` | List all topic configuration, with pagination. |
| `POST` | `/api/v0/topic_configuration` | Create a new topic configuration. |
| `GET` | `/api/v0/topic_configuration/:topic-configuration-id` | Return the details of a specific topic configuration. |
| `PUT` | `/api/v0/topic_configuration/:topic-configuration-id` | Update a specific topic configuration. |
| `DELETE` | `/api/v0/topic_configuration/:topic-configuration-id` | Delete a specific topic configuration data. |

### Topic Definition
| Method | Endpoint | Description |
|---|---|---|
| `GET` | `/api/v0/topic_definition` | List all topic definition, with pagination. |
| `POST` | `/api/v0/topic_definition` | Create a new topic definition. |
| `GET` | `/api/v0/topic_definition/:topic-definition-name` | Return the details of a specific topic definition. |
| `PUT` | `/api/v0/topic_definition/:topic-definition-name` | Update a specific topic definition. |
| `DELETE` | `/api/v0/topic_definition/:topic-definition-name` | Delete a specific topic definition data. |
