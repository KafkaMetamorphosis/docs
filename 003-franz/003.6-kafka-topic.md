...
- **Governance** — Policies may act on a Kafka Topic (`SET_STATUS`,
  field mutation, labels) when an indicator limit is crossed (`003.8`); the
  per-field write whitelist is an open decision.
